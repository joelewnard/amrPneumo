# Restrict meta-regression analysis to only studies that include both NS and RES data 
# Response to reviewer #4 comment #4 about needing to restrict to an identical corpus 
# Updated 12-2-20
...
# LOOP FOR FIGURE 4
pdf("/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/plots/plot_fig4_corpus.pdf", width=5, height=4.5) 
