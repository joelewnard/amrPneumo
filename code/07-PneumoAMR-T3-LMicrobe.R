# Create Table 3- INCLUDING ATLAS Isolates AND Table S5 (not including ATLAS isolates)
# Kristin Andrejko
# Last updated 12-8-20


#To use data frame that INCLUDES ATLAS isolates for MS Table 3
fulldta_table1_032410_atl <- read_excel("/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/data/fulldta_table1_032410_final_plusAtlasID.xlsx") #this is final table excel for these tables- includes serotype data- do not use for analysis
fulldta_table1_032410 <- fulldta_table1_032410_atl

#See what happens when we EXCLUDE teh serotype_only ones
fulldta_table1_032410_v2 <- fulldta_table1_032410 %>% dplyr::filter(is.na(serotype_only))

length(unique(fulldta_table1_032410_v2$studyID))
length(unique(fulldta_table1_032410_v2$doi))
...
View(fulldta_table1_032410)

#Add last serotype data dump
...
# gps_data$total_isolates_drug <- gps_data$serotype_isolates
# 
# #Fix format of gps_data (serotype) to make it add correctly 
# test <- gps_data %>% 
#   dplyr::group_by(studyID, arm_id) %>% 
#   dplyr::summarize(total_isolates_new = length(serotype))
# View(test)
#                 
# 
...
#                 region, total_isolates_drug, no_ns, no_res)
# 
# fulldta3 <- rbind(fulldta_table1_032410, gps_data_keep)  
# fulldta_table1_032410 <- fulldta3
...
write.csv(ns_tb, "/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/11-30-20/tb3/ns_tb_pen.csv")
write.csv(res_tb, "/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/11-30-20/tb3/res_tb_pen.csv")
write.csv(pen_tb3, "/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/11-30-20/tb3/pen_tb3.csv")
...
mac_tb3 <- data.frame(merge(ns_tb, res_tb, by = "region")) %>% dplyr::select(region, fin_ns_mac, fin_res_mac) %>% 
  arrange(match(region, order_region_s)) 
View(mac_tb3)
write.csv(ns_tb, "/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/11-30-20/tb3/ns_tb_mac.csv")
write.csv(res_tb, "/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/11-30-20/tb3/res_tb_mac.csv")
write.csv(mac_tb3, "/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/11-30-20/tb3/mac_tb3.csv")
...
write.csv(ns_tb, "/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/11-30-20/tb3/ns_tb_sxt.csv")
write.csv(res_tb, "/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/11-30-20/tb3/res_tb_sxt.csv")
...
write.csv(ns_tb, "/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/11-30-20/tb3/ns_tb_ceph.csv")
write.csv(res_tb, "/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/11-30-20/tb3/res_tb_ceph.csv")
...
write.csv(ns_tb, "/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/11-30-20/tb3/ns_tb_tet.csv")
write.csv(res_tb, "/Users/kristinandrejko/Box/01-Research/02-SP-AMR/LancetMicrobe-Revision/PneumoAMR-LMicrobe/output/11-30-20/tb3/res_tb_.csv")
